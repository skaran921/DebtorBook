                          ...
                          <?php                      
                            ...
                            foreach($reminders as $reminder){                                
                              ...
                              <tr class="p-4">
                                ...
                                <td>                                 
                                    <a href="javascript:void(0)" class="btn rounded-circle btn-primary" onclick="window.open('./editReminder.php?reminder=<?php echo $encryted_reminder_id;?>','_blank')"> <i class="fa fa-pencil"></i> </a>
