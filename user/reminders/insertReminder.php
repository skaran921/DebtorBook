...
<head>
    ...
    <title>Create Reminder - Debtor Book</title>
    <?php 
...
<body>
    ...
    <div class="sidebarContent">
          ...
          <!-- navbar end-->
            ...
            <!-- main content-->
            <div class="main p-5">
                  <h1 class="gray-text"> <i class="fa fa-plus-square"></i> Create Reminder</h1>
                  <hr/>
                     ...
                     <div class="row">
                         <div class="col-md-12 col-lg-6 col-sm-12">
                             ...
                             <div class="form-group">
                                ...
                                <input class="flatpickr flatpickr-input mb-2" id="reminderDate" name="reminderDate" type="text" placeholder="Select Reminder Date" data-id="datetime" readonly="readonly" autofocus required>       
                             </div>

                             <!-- reminder -->
                             <div class="form-group">
                                 <label class="gray-text">Reminder*</label>                                
                                 <textarea name="reminder" id="reminder" class="mb-2" placeholder="write your reminder..." required></textarea>                               
                             </div>


                             <!--submit button -->
                          <button type="submit" class="btn-block" name="insertReminder"><i class="fa fa-save"></i> Save</button>
                         </div>
                     </div>
                  </form>
            </div> <!---main -------->
   ...
   if(
       ...
       isset($_POST["insertReminder"]) 
        ...
        if(!ValidationHelper::validateDate($reminderDate)){
         ...
         $result = $reminders->insertNewReminder($reminderDate,$reminder);
         if($result){
