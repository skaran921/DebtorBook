...
<head>
    ...
    <title>Received Amount Report - Debtor Book</title>
    <?php 
...
<body>
    ...
    <div class="sidebarContent">
          ...
          <!-- navbar end-->
            ...
            <!-- main content-->
            <div class="main p-2">
                  <h1 class="gray-text"> <i class="fa fa-list-alt"></i> Received Amount Report</h1>
                  <div>
                  ...
                  <table class="table stripe display nowrap" id="debtorsTable" style="width:100%">
                      ...
                      <tbody>
                          <?php   
                            ...
                            $transactions = $transaction->getReceivedTransactionBetweenTwoTransactionDate($startDate,$endDate);
                            $srNo =1;
                            $totalPay = 0.0;
                            $totalReceived = 0.0;
